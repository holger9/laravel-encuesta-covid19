  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header bg-danger">
        <h4 class="mb-0 text-white">Perfil del usuario</h4>
      </div>
      <div class="card-body text-center">
        ...
        <a href="{{ route('home') }}" class="btn btn-outline-danger">
          <i data-feather="arrow-left" class="feather-icon"></i> Salir
        </a>
        <a href="{{ route('profile.edit', $user->id) }}" class="btn btn-outline-success">
